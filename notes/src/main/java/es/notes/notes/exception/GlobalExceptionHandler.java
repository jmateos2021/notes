...
public class GlobalExceptionHandler extends RuntimeException{
    ...
    // @ExceptionHandler(NoteNotFoundException.class): Este método se ejecutará
    // cuando cualquier controlador lance una NoteNotFoundException. @ExceptionHandler(NoteNotFoundException.class)
    // El método devuelve un ModelAndView, que nos permite especificar tanto
    ...
    // 3. Establecer el código de estado HTTP 404. modelAndView.setStatus(HttpStatus.NOT_FOUND);
        return modelAndView; }
